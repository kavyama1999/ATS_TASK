...
/**
 * The persistence utility for the customer_table service. This utility wraps <code>com.liferay.service.persistence.impl.customer_tablePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see customer_tablePersistence
 * @generated
 */
public class customer_tableUtil {
	 ...
	 */
	public static void clearCache(customer_table customer_table) {
		getPersistence().clearCache(customer_table);
	}
	 ...
	 */
	public static Map<Serializable, customer_table> fetchByPrimaryKeys(
	 ...
	 */
	public static List<customer_table> findWithDynamicQuery(
	 ...
	 */
	public static customer_table update(customer_table customer_table) {
		return getPersistence().update(customer_table);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static customer_table update(
		customer_table customer_table, ServiceContext serviceContext) {

		return getPersistence().update(customer_table, serviceContext);
	}
	 ...
	 */
	public static List<customer_table> findByUuid(String uuid) {
	 ...
	 */
	public static List<customer_table> findByUuid(
	 ...
	 */
	public static customer_table findByUuid_First(
			String uuid, OrderByComparator<customer_table> orderByComparator)
		throws com.liferay.exception.NoSuchcustomer_tableException {
	 ...
	 */
	public static customer_table fetchByUuid_First(
		String uuid, OrderByComparator<customer_table> orderByComparator) {
	 ...
	 * @throws NoSuchcustomer_tableException if a matching customer_table could not be found
	 */
	public static customer_table findByUuid_Last(
			String uuid, OrderByComparator<customer_table> orderByComparator)
		throws com.liferay.exception.NoSuchcustomer_tableException {
	 ...
	 */
	public static customer_table fetchByUuid_Last(
		String uuid, OrderByComparator<customer_table> orderByComparator) {
	 ...
	 */
	public static customer_table[] findByUuid_PrevAndNext(
			long custId, String uuid,
			OrderByComparator<customer_table> orderByComparator)
		throws com.liferay.exception.NoSuchcustomer_tableException {

		return getPersistence().findByUuid_PrevAndNext(
			custId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchcustomer_tableException if a matching customer_table could not be found
	 */
	public static customer_table findByUUID_G(String uuid, long groupId)
		throws com.liferay.exception.NoSuchcustomer_tableException {
	 ...
	 */
	public static customer_table fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching customer_table, or <code>null</code> if a matching customer_table could not be found
	 */
	public static customer_table fetchByUUID_G(
	 ...
	 */
	public static customer_table removeByUUID_G(String uuid, long groupId)
		throws com.liferay.exception.NoSuchcustomer_tableException {
	 ...
	 * @return the matching customer_tables
	 */
	public static List<customer_table> findByUuid_C(
	 ...
	 * @throws NoSuchcustomer_tableException if a matching customer_table could not be found
	 */
	public static customer_table findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<customer_table> orderByComparator)
		throws com.liferay.exception.NoSuchcustomer_tableException {
	 ...
	 * @return the first matching customer_table, or <code>null</code> if a matching customer_table could not be found
	 */
	public static customer_table fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<customer_table> orderByComparator) {
	 ...
	 * @throws NoSuchcustomer_tableException if a matching customer_table could not be found
	 */
	public static customer_table findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<customer_table> orderByComparator)
		throws com.liferay.exception.NoSuchcustomer_tableException {
	 ...
	 * @return the last matching customer_table, or <code>null</code> if a matching customer_table could not be found
	 */
	public static customer_table fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<customer_table> orderByComparator) {
	 ...
	 * @throws NoSuchcustomer_tableException if a customer_table with the primary key could not be found
	 */
	public static customer_table[] findByUuid_C_PrevAndNext(
			long custId, String uuid, long companyId,
			OrderByComparator<customer_table> orderByComparator)
		throws com.liferay.exception.NoSuchcustomer_tableException {

		return getPersistence().findByUuid_C_PrevAndNext(
			custId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(customer_table customer_table) {
		getPersistence().cacheResult(customer_table);
	}
	 ...
	 */
	public static void cacheResult(List<customer_table> customer_tables) {
		getPersistence().cacheResult(customer_tables);
	}
	 ...
	 */
	public static customer_table create(long custId) {
		return getPersistence().create(custId);
	}
	 ...
	 * @throws NoSuchcustomer_tableException if a customer_table with the primary key could not be found
	 */
	public static customer_table remove(long custId)
		throws com.liferay.exception.NoSuchcustomer_tableException {

		return getPersistence().remove(custId);
	}

	public static customer_table updateImpl(customer_table customer_table) {
		return getPersistence().updateImpl(customer_table);
	}
	 ...
	 * @throws NoSuchcustomer_tableException if a customer_table with the primary key could not be found
	 */
	public static customer_table findByPrimaryKey(long custId)
		throws com.liferay.exception.NoSuchcustomer_tableException {

		return getPersistence().findByPrimaryKey(custId);
	}
	 ...
	 */
	public static customer_table fetchByPrimaryKey(long custId) {
		return getPersistence().fetchByPrimaryKey(custId);
	}
	 ...
	 */
	public static List<customer_table> findAll() {
	 ...
	 */
	public static List<customer_table> findAll(int start, int end) {
	...
	public static customer_tablePersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(customer_tablePersistence persistence) {
		_persistence = persistence;
	}

	private static volatile customer_tablePersistence _persistence;
