...
public class employeeLocalServiceWrapper
	 ...
	 */
	@Override
	public employe.db.layer.model.employee addemployee(
		employe.db.layer.model.employee employee) {
	 ...
	 */
	@Override
	public employe.db.layer.model.employee createemployee(long empId) {
	 ...
	 */
	@Override
	public employe.db.layer.model.employee deleteemployee(
		employe.db.layer.model.employee employee) {
	 ...
	 */
	@Override
	public employe.db.layer.model.employee deleteemployee(long empId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public employe.db.layer.model.employee fetchemployee(long empId) {
	 ...
	 */
	@Override
	public employe.db.layer.model.employee fetchemployeeByUuidAndGroupId(
	 ...
	 */
	@Override
	public employe.db.layer.model.employee getemployee(long empId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public java.util.List<employe.db.layer.model.employee> getEmployeeByCompany(
		String company) {

		return _employeeLocalService.getEmployeeByCompany(company);
	}
	 ...
	 */
	@Override
	public employe.db.layer.model.employee getemployeeByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<employe.db.layer.model.employee> getemployees(
		int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<employe.db.layer.model.employee>
	...
	public java.util.List<employe.db.layer.model.employee>
		getemployeesByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<employe.db.layer.model.employee> orderByComparator) {
	...
	@Override
	public employe.db.layer.model.employee getInstance() {
		return _employeeLocalService.getInstance();
	}
	 ...
	 */
	@Override
	public employe.db.layer.model.employee updateemployee(
		employe.db.layer.model.employee employee) {
