...
/**
 * The base model interface for the Ambulance service. Represents a row in the &quot;HSP_Ambulance&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>AddAmbulanceDb.model.impl.AmbulanceModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>AddAmbulanceDb.model.impl.AmbulanceImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface AmbulanceModel extends BaseModel<Ambulance> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a ambulance model instance should use the {@link Ambulance} interface instead.
	 */
