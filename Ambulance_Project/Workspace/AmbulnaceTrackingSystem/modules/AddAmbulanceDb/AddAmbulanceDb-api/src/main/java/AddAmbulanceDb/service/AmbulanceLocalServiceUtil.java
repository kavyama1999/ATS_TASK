...
/**
 * Provides the local service utility for Ambulance. This utility wraps
 * <code>AddAmbulanceDb.service.impl.AmbulanceLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AmbulanceLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>AddAmbulanceDb.service.impl.AmbulanceLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Ambulance addAmbulance(Ambulance ambulance) {
		return getService().addAmbulance(ambulance);
	}
	 ...
	 */
	public static Ambulance createAmbulance(long ambulanceId) {
		return getService().createAmbulance(ambulanceId);
	}
	 ...
	 */
	public static Ambulance deleteAmbulance(Ambulance ambulance) {
		return getService().deleteAmbulance(ambulance);
	}
	 ...
	 */
	public static Ambulance deleteAmbulance(long ambulanceId)
		throws PortalException {

		return getService().deleteAmbulance(ambulanceId);
	}
	...
	public static Ambulance fetchAmbulance(long ambulanceId) {
		return getService().fetchAmbulance(ambulanceId);
	}
	 ...
	 * @throws PortalException if a ambulance with the primary key could not be found
	 */
	public static Ambulance getAmbulance(long ambulanceId)
		throws PortalException {

		return getService().getAmbulance(ambulanceId);
	}
	 ...
	 */
	public static List<Ambulance> getAmbulances(int start, int end) {
		return getService().getAmbulances(start, end);
	}
	 ...
	 */
	public static int getAmbulancesCount() {
		return getService().getAmbulancesCount();
	}
	 ...
	 */
	public static Ambulance updateAmbulance(Ambulance ambulance) {
		return getService().updateAmbulance(ambulance);
	}

	public static AmbulanceLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AmbulanceLocalService> _serviceSnapshot =
		new Snapshot<>(
			AmbulanceLocalServiceUtil.class, AmbulanceLocalService.class);
