...
public abstract class BaseStudentResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/CaseMgmt/v1.0/get-student'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/CaseMgmt/v1.0/add-student' -d $'{"data": ___, "id": ___, "name": ___, "standard": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/CaseMgmt/v1.0/update-student' -d $'{"data": ___, "id": ___, "name": ___, "standard": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/CaseMgmt/v1.0/delete-student'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/CaseMgmt/v1.0/delete-student/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
