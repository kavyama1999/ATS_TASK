...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "AccountMgmtSystemHeadlessAPI REST API", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "AccountMgmtSystemHeadlessAPI", version = "v1.0")
)
@Path("/v1.0")
