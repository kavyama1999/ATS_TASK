package AccountMgmtSystem.Headless_API.client.resource.v1_0;
...
import AccountMgmtSystem.Headless_API.client.problem.Problem;
...
public interface AccountResource {
	...
	public HttpInvoker.HttpResponse getAccountsHttpResponse() throws Exception;

	public AccountMngt addAccount(AccountMngt accountMngt) throws Exception;

	public HttpInvoker.HttpResponse addAccountHttpResponse(
			AccountMngt accountMngt)
		throws Exception;
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public Page<AccountMngt> getAccounts() throws Exception {
			HttpInvoker.HttpResponse httpResponse = getAccountsHttpResponse();
			...
			try {
				return Page.of(content, AccountMngtSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getAccountsHttpResponse()
			throws Exception {
		...
		public AccountMngt addAccount(AccountMngt accountMngt)
			throws Exception {
			...
			try {
				return AccountMngtSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse addAccountHttpResponse(
			...
			httpInvoker.body(accountMngt.toString(), "application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/AccountMgmtSystem-Headless_API/v1.0/add-account");
		...
		public AccountMngt updateAccount(AccountMngt accountMngt)
			throws Exception {
		...
		public HttpInvoker.HttpResponse updateAccountHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/AccountMgmtSystem-Headless_API/v1.0/update-account");
		...
		public HttpInvoker.HttpResponse deleteAccountHttpResponse(
			...
			httpInvoker.body(accountId.toString(), "application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/AccountMgmtSystem-Headless_API/v1.0/delete-account");
		...
		public HttpInvoker.HttpResponse deleteAccountBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/AccountMgmtSystem-Headless_API/v1.0/delete-account/batch");
